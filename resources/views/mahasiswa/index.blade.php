                            ...
                            <div class="card">
                                <div class="stat-widget-one">
                                    ...
                                    <div class="stat-content dib">
                                        <div class="stat-text">IP KUMULATIF</div>
                                        <div class="stat-digit">3.95</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-3">
                            <div class="card">
                                <div class="stat-widget-one">
                                    ...
                                    <div class="stat-content dib">
                                        <div class="stat-text">IP SEMESTER 5</div>
                        ...
                        <div class="col-lg-3">
                            <div class="card">
                                <div class="stat-widget-one">
                                    ...
                                    <div class="stat-content dib">
                                        <div class="stat-text">STATUS AKADEMIK</div>
                                        <div class="stat-digit">AKTIF</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-3">
                            <div class="card">
                                <div class="stat-widget-one">
                                    ...
                                    <div class="stat-content dib">
                                        <div class="stat-text">SKS KUMULATIF</div>
                        ...
                        <div class="col-sm-9 col-md-6 col-lg-9">
                            <div class="card">
                                <div class="stat-widget-one">
                                    ...
                                    <div class="stat-content dib">
                                        <div class="stat-text">STATUS PKL</div>
                                        <div class="stat-digit">BELUM AMBIL</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-9 col-md-6 col-lg-8 col-xl-10">
                            <div class="card">
                                <div class="stat-widget-one">
                                    ...
                                    <div class="stat-content dib">
                                        <div class="stat-text">STATUS SKRIPSI</div>
                                        <div class="stat-digit">BELUM AMBIL</div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-sm-9 col-md-6 col-lg-8 col-xl-10">
                            <div class="card">
                                <div class="stat-widget-one">
                                    ...
                                    <div class="stat-content dib">
                                        <div class="stat-text">DOSEN WALI</div>
                                        <div class="stat-digit">Dr. Aris Puji Widodo, S.Si., M.T.</div>
                                    </div>
                                </div>
                            </div>
                        </div>
